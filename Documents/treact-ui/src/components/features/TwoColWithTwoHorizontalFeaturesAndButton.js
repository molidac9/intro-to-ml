...
export default ({
  ...
  heading = (
    <>
      Real World <span tw="text-primary-500">Applications.</span>
    </>
  ),
  description = "Machine Learning is an upcoming field that has been recognized by companies for its usefulness and innovative techniques. Many major companies now use Machine Learning to better themselves.",
